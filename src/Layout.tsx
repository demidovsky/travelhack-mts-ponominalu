            ...
            <section className="mt-5 wow fadeIn">
              <div className="row">
                ...
                <div className="col-md-6 mb-4">
                  ...
                  <p>
                    This template is created with Material Design for Bootstrap (<strong>MDB</strong> ) framework.
                  </p>
                ...
                <div className="col-lg-6 col-md-12 px-4">
                  ...
                  <div className="row">
                    ...
                    <div className="col-10">
                      ...
                      <p className="grey-text">
                        We give you detailed user-friendly documentation at your disposal. It will help you to implement
                        your ideas easily.
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="row">
                    ...
                    <div className="col-10">
                      ...
                      <p className="grey-text">
                        We care about the development of our users. We have prepared numerous tutorials, which allow you
                        to learn how to use MDB as well as other technologies.
                      </p>
                    </div>
                  </div>
                </div>
                ...
                <div className="col-md-4">
                  <div className="row">
                    ...
                    <div className="col-10">
                      ...
                      <p className="grey-text">
                        Our license is user-friendly. Feel free to use MDB for both private as well as commercial
                        projects.
                      </p>
                  ...
                  <div className="row">
                    ...
                    <div className="col-10">
                      ...
                      <p className="grey-text">
                        It doesn't matter whether your project will be displayed on desktop, laptop, tablet or mobile
                        phone. MDB looks great on each screen.
                      </p>
                      <div style={{height: "15px"}}></div>
                    </div>
                  </div>
                ...
                <div className="col-md-4 mt-2">
                  <div className="row">
                    ...
                    <div className="col-10">
                      ...
                      <p className="grey-text">
                        Neat and easy to use animations, which will increase the interactivity of your project and
                  ...
                  <div className="row">
                    ...
                    <div className="col-10">
                      ...
                      <p className="grey-text">
                        Using MDB is straightforward and pleasant. Components flexibility allows you deep customization.
                        You will easily adjust each component to suit your needs.
                      </p>
                      <div style={{height: "15px"}}></div>
                    </div>
                  </div>
                  ...
                  <div className="row">
                    ...
                    <div className="col-10 mb-2 pl-3">
                      ...
                      <p className="grey-text mt-2">
                        Chrome, Firefox, IE, Safari, Opera, Microsoft Edge - MDB loves all browsers; all browsers love
                        MDB.
                      </p>
                    </div>
                  </div>
                ...
                <div className="col-xl-3 col-lg-6">
                  <div className="row">
                    ...
                    <div className="col-10 mb-2">
                      ...
                      <p className="grey-text mt-2">
                        MDB is integrated with newest jQuery. Therefore you can use all the latest features which come
                        along with it.
                      </p>
                    </div>
                  </div>
                ...
                <div className="col-xl-3 col-lg-6">
                  <div className="row">
                    ...
                    <div className="col-10 mb-2">
                      ...
                      <p className="grey-text mt-2">
                        Material Design for Bootstrap comes with both, compiled, ready to use libraries including all
                        features as well as modules for CSS (SASS files) and JS.
                      </p>
                    </div>
                  </div>
                </div>
