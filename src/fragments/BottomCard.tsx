...
export class BottomCard extends Component<MyProps, MyState> {
  onClick = () => {
    ...
    pnwidget.show({
      ...
      event: { alias: alias /*date: datetime[0], time:datetime[1]*/ },
      tickets_show: true,
      exclude_dates: true,
      customStyle: true,
      hideHeader: false,
  ...
  render() {
    ...
    const src =
      this.props.item.src ||
      `https://media.ponominalu.ru/i/600x300/${evt.image}`;
    return (
      <Card onClick={this.onClick}>
        <CardHeadBlock>
          <CardHead
            style={{ height: this.props.item.large ? "300px" : "170px" }}
          >
        ...
        <div>
          <div className="btn btn-black btn-large" onClick={this.onClick}>
            <b>BUY TICKET</b>
          </div>
